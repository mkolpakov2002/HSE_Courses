...
//        startingPoint = tooltipAnchorBottomPoint + context.dpToPx(10)
        startingPoint = context.dpToPx(30)
        ...
        canvas.apply {
            ...
            for (i in 0 until listGraphValues.size) {
                ...
                if (graphValue.isToday) {
                    ...
                    val dayText: String = when (graphValue.day) {
                        0 -> context.getString(R.string.day_mo)
                        1 -> context.getString(R.string.day_tu)
                        2 -> context.getString(R.string.day_we)
                        3 -> context.getString(R.string.day_th)
                        4 -> context.getString(R.string.day_fr)
                        5 -> context.getString(R.string.day_sa)
                        6 -> context.getString(R.string.day_su)
                        else -> {
                            context.getString(R.string.day_mo)
                        }
                    }
                    val dayRect = Rect()
